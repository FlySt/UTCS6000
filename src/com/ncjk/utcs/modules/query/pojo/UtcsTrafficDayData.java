 ...
 */
@Entity
@Table(name = "UTCS_TRAFFICDAY_DATA")
public class UtcsTrafficDayData {

    private Integer trafficDayDataId;
    ...
    @Column(name = "TRAFFICDAY_DATA_ID")
    public Integer getTrafficDayDataId() {
        return trafficDayDataId;
    }

    public void setTrafficDayDataId(Integer trafficDayDataId) {
        this.trafficDayDataId = trafficDayDataId;
    }
